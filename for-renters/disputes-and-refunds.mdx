...
<AccordionGroup>
  ...
  <Accordion title="What if the platform disappears?">
    The contract has an anyone-after-expiry release: once your rental's `endTime` passes, anyone can call `release()` to settle the owner. There's no equivalent for refunds — those require operator action. If the platform vanishes mid-rental, you'd need to wait until expiry, at which point funds release to the owner.
  </Accordion>
</AccordionGroup>
